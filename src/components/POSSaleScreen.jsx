...
const POSSaleScreen = ({ session, onLogout }) => {
  ...
  const defaultActionButtons = [
    ...
    { id: 4, label: 'Digital Wallet', action_type: 'custom_function', action_value: 'Digital Wallet coming soon', color: '#6B7280', position: 4 },
    {
      id: 5, label: 'Promotion', button_type: 'parent', color: '#6B7280', position: 5,
      sub_buttons: [
        { id: 'promotion-discount', label: 'Discount', action_type: 'open_modal', action_config: { modal_type: 'discount' } },
        { id: 'promotion-voucher', label: 'Voucher', action_type: 'open_modal', action_config: { modal_type: 'voucher' } },
      ],
    },
                ...
                return (
                  <div key={button.id || index} className="relative">
                    <button
                      ...
                      style={{ ...(button.color ? { borderColor: button.color, borderWidth: '2px' } : { borderColor: '#E5E7EB' }), height: '48px' }}
                    >
                      <span
